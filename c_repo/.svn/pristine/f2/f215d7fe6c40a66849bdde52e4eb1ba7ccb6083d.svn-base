...
if($results){ //we have records
    while($row = $results->fetch_object()) {
        ...
        $description = $item->addChild('description', htmlentities($row->item_description)); //add description
