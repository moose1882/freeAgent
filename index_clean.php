...
$mysqli = new mysqli("localhost", "root", "0p3nW1nd0w5", "rssdb");
...
echo "Trying to connect to db...<br/><br/>";
echo "Using these creds '" . $db . "'";

	if (!$db_connect)
	{
		die('Could not connect: ' . mysql_error());
	}
	$db_select = mysql_select_db('rssdb', $db);
	if (!$db_select)
	{
		die('Could not connect: ' . mysql_error());
	}
